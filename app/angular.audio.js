...
angular.module('ngAudio', [])
       ...
       .service('remoteAudioFindingService',
         ['$q', 'ngAudioUidLookup', 'ngAudioUidGenerator', function ($q, ngAudioUidLookup, ngAudioUidGenerator) {
       ...
       .service('cleverAudioFindingService', ['$q', 'localAudioFindingService', 'remoteAudioFindingService',
       ...
       .factory('NgAudioObject', ['cleverAudioFindingService', '$rootScope', '$interval', '$timeout', 'ngAudioGlobals',
         function (cleverAudioFindingService, $rootScope, $interval, $timeout, ngAudioGlobals) {
           return function (id, scope) {
             ...
             $intervalWatch = $scope.$watch(function () {
               ...
               $interval.cancel(interval);
               interval = $interval(checkWatchers, ngAudioGlobals.performance, 0, false);
             });
